...
class TypeTestCase(test.CdistTestCase):
    ...
    def test_list_type_names(self):
        ...
        type_names = list(core.CdistType.list_type_names(base_path))
    ...
    def test_list_types(self):
        ...
        types_expected = [
            ...
            core.CdistType(base_path, '__namespace.some_type'),
            core.CdistType(base_path, '__namespace.folder.nested_type'),
        ]
